  ...
  let tabs = [
    {
      ...
      label: "會計學",
      content:
        "會計學是研究財務信息的科學，關注企業的財務狀況和經營成果。在這門課程中，我們將學習如何記錄企業的財務交易，編制財務報表並進行相應的分析。學生將學會解讀資產負債表、損益表和現金流量表，評估企業的經濟實力、風險和價值。這些知識和技能對於投資者、管理者和其他利害相關者都非常重要，幫助他們做出明智的決策和提供可靠的財務信息。",
    },
    {
      id: "economic",
      label: "經濟學",
    ...
    },
    {
      ...
      label: "C++程式設計",
      content:
        "如果目標是一類組財務、金融、會計、企管的學員 一定要學會寫c++程式語言，資財營程式設計課程教授C++基礎的語法，並透過上機實作和專案開發，讓學生學以致用，更快速掌握這個世代「金融科技」的浪潮!",
    },
  ];
