  ...
  return (
    <div className="bg-black w-full h-[120px] flex flex-row  border-t-1 border-[#15151e] justify-center items-center">
      <div className=" flex-shrink-0 flex flex-col gap-2 mt-[2rem]">
        <div className="  text-gray-100 font-normal  xl:text-[15px] lg:text-[15px] md:text-[12px] text-[10px] ">
          總召：王子儀 0927382377
        </div>
        <div className="  text-gray-100 font-normal  xl:text-[15px] lg:text-[15px] md:text-[12px] text-[10px]">
          副召：何宜霓 0988882689
        </div>
        <div className="  text-gray-100 font-normal  xl:text-[15px] lg:text-[15px] md:text-[12px] text-[10px] mb-4">
