  ...
  return (
    <div className="bg-black w-full h-[120px] flex flex-row  border-t-1 border-[#15151e] justify-center items-center">
      <div className=" flex-shrink-0 flex flex-col gap-2 mt-[2rem]">
        <div className="  text-gray-100 font-normal  xl:text-[15px] text-[12px] ">
          總召：王子儀 0927382377
        </div>
        <div className="  text-gray-100 font-normal  xl:text-[15px] text-[12px]">
          副召：何宜霓 0988882689
      ...
      <div className="xl:ml-[30rem]  flex flex-col  ">
        ...
        <p className="w-custom text-center text-gray-500 text-xs font-normal leading-normal ml-[1.88rem] relative top-[1.5rem]">
